import { fetchAuthenticatedUser, requestLogout } from "./auth-api.js";
import { getDashboardDom } from "./dom.js";
import { bindDashboardNavigation } from "./navigation.js";
import { createPaymentsService } from "./payments-service.js";
import { createUsersService } from "./users-service.js";
import { setSidebarUserEmail, setSummaryInfo, showFeedback } from "./ui.js";
...
async function initializeDashboard() {
  ...
  bindDashboardNavigation(dom.sidebarButtons, dom.panels);
  bindLogout(dom.logoutButton, dom.feedback);

  const usersService = createUsersService(dom.users, dom.users.tableBody, dom.feedback, showFeedback);
